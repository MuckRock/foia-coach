...
**Solution:** Make sure you set `OPENAI_REAL_API_ENABLED=true` in `.envs/.local/.api` and restarted the service.
...
- [SvelteKit Integration Guide](../api/SVELTEKIT_INTEGRATION_GUIDE.md)
