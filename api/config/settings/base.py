...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "django-insecure-foia-coach-api-dev-key-change-in-production"
)
...
GEMINI_REAL_API_ENABLED = os.environ.get(
...
OPENAI_MODEL = os.environ.get(
    "OPENAI_MODEL", "gpt-4.1"  # Latest model with Responses API support
)
...
MUCKROCK_API_URL = os.environ.get(
    "MUCKROCK_API_URL", "http://dev.muckrock.com"  # Default uses /etc/hosts mapping
)
